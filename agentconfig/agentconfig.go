...
func addRequestHeaders(req *http.Request) (*http.Request, error) {
	...
	req.Header.Add(certIdHeaderKey, onPremConfig.CertId)
	req.Header.Add(instanceIdHeaderKey, onPremConfig.InstanceId)
	...
	req.Header.Add(authHeaderKey, authHeaderPrefix + sig)
	return req, nil
}
